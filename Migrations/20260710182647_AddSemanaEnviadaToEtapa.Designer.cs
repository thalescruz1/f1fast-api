...
namespace F1Fast.API.Migrations
{
    ...
    [Migration("20260710182647_AddSemanaEnviadaToEtapa")]
    partial class AddSemanaEnviadaToEtapa
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("F1Fast.API.Models.Etapa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Classificacao = new DateTime(2026, 3, 7, 2, 0, 0, 0, DateTimeKind.Utc),
                            DataCorrida = new DateTime(2026, 3, 7, 22, 0, 0, 0, DateTimeKind.Utc),
                            Distancia = "306.1 km",
                            Encerrada = false,
                            ...
                            Numero = 1,
                            Pais = "au",
                            PrazoQualify = new DateTime(2026, 3, 6, 23, 0, 0, 0, DateTimeKind.Utc),
                            Recordista = "Charles Leclerc",
                            SemanaEnviada = false,
                            Sprint = false,
                            TempoRecord = "1:19.813",
                            TreinoLivre1 = new DateTime(2026, 3, 5, 22, 30, 0, 0, DateTimeKind.Utc),
                            TreinoLivre2 = new DateTime(2026, 3, 6, 2, 0, 0, 0, DateTimeKind.Utc),
                            TreinoLivre3 = new DateTime(2026, 3, 6, 22, 30, 0, 0, DateTimeKind.Utc),
                            Voltas = 58
                        },
                        new
                        {
                            ...
                            Classificacao = new DateTime(2026, 3, 12, 5, 30, 0, 0, DateTimeKind.Utc),
                            DataCorrida = new DateTime(2026, 3, 13, 1, 30, 0, 0, DateTimeKind.Utc),
                            Distancia = "103.6 km",
                            Encerrada = false,
                            LembreteEnviado = false,
                            LembreteUrgenteEnviado = false,
                            ...
                            Numero = 2,
                            Pais = "cn",
                            PrazoQualify = new DateTime(2026, 3, 13, 1, 30, 0, 0, DateTimeKind.Utc),
                            Recordista = "Michael Schumacher",
                            SemanaEnviada = false,
                            Sprint = true,
                            TempoRecord = "1:32.238",
                            TreinoLivre1 = new DateTime(2026, 3, 12, 2, 0, 0, 0, DateTimeKind.Utc),
                            Voltas = 19
                        },
                        new
                        {
                            ...
                            CircuitoSvg = "<svg width=\"500\" height=\"500\" xml:space=\"preserve\" xmlns=\"http://www.w3.org/2000/svg\"> <path style=\"fill: none; stroke: currentColor; stroke-width: 20; stroke-linejoin: round; stroke-dasharray: none; stroke-opacity: 1;\" d=\"M457.499 211.881c-5.788-8.465-14.832-13.126-25.467-13.126-10.565 0-22.335 4.768-28.618 11.593-2.966 3.22-4.412 6.674-4.192 9.985.385 5.707 4.117 12.018 11.09 18.76.58.558.56 1.21.496 1.55a1.62 1.62 0 0 1-1 1.235l-140.705 57.863c-3.676 1.504-8.039.824-11.115-1.713-4.917-4.05-10.074-8.995-15.331-14.696-1.851-2.015-1.47-4.279-1.22-5.16.254-.895 1.135-3.054 3.816-3.772 1.58-.422 3.201-.827 4.852-1.244 8.74-2.195 18.644-4.684 29.538-10.987 22.33-12.915 15.017-35.707 12.47-43.641-2.565-8.031-8.343-11.919-20.999-20.44l-6.193-4.156c-12.215-8.138-20.289-13.514-23.636-30.018-3.506-17.247 4.767-35.443 19.25-42.328 6.662-3.166 15.551-6.414 25.846-10.175 14.561-5.315 31.059-11.342 48.502-19.655 19.148-9.13 26.922-20.15 30.073-27.79a10.335 10.335 0 0 0-.9-9.615c-2.066-3.143-5.663-4.876-9.414-4.455-16.252 1.816-51.748 7.028-71.462 9.974a58.318 58.318 0 0 0-21.005 7.422c-20.09 11.804-62.168 38.651-79.331 49.643-3.812 2.446-8.639 2.984-12.89 1.413-4.633-1.708-8.56-3.524-11.661-5.395-3.042-1.84-4.912-4.103-5.412-6.544-.44-2.156.19-4.564 1.77-6.777.956-1.343 1.741-1.454 2.402-1.454 2.13 0 4.972 1.74 6.193 2.484l.6.376c2.736 1.712 7.823 4.9 13.641 4.897 4.152 0 9.95-1.642 14.011-9.46 3.332-6.412 3.271-14.022-.16-20.878-4.662-9.314-14.606-15.945-26.607-17.741-11.655-1.741-24.816 3.435-33.865 13.268-6.828 7.414-10.415 16.494-9.85 24.905l18.634 276.007a1.82 1.82 0 0 1-1.02 1.758l-85.62 40.82-1.245.837c-4.492 4.09-9.61 10.604-15.212 19.359-1.99 3.103-2.15 6.881-.425 10.109 1.731 3.235 5.022 5.245 8.584 5.245 1.336 0 2.651-.28 3.912-.83 61.903-27.052 371.598-162.394 389.161-170.146 11.926-5.263 21.7-16.983 25.512-30.587 3.62-12.923 1.56-25.963-5.798-36.72z\" /> </svg>",
                            CircuitoTipo = "Circuito permanente",
                            Classificacao = new DateTime(2026, 3, 13, 5, 30, 0, 0, DateTimeKind.Utc),
                            DataCorrida = new DateTime(2026, 3, 14, 1, 0, 0, 0, DateTimeKind.Utc),
                            Distancia = "305.1 km",
                            Encerrada = false,
                            LembreteEnviado = false,
                            LembreteUrgenteEnviado = false,
                            ...
                            Numero = 3,
                            Pais = "cn",
                            PrazoQualify = new DateTime(2026, 3, 14, 1, 0, 0, 0, DateTimeKind.Utc),
                            Recordista = "Michael Schumacher",
                            SemanaEnviada = false,
                            Sprint = false,
                            TempoRecord = "1:32.238",
                        ...
                        new
                        {
                            ...
                            CircuitoTipo = "Circuito permanente",
                            Classificacao = new DateTime(2026, 3, 27, 4, 0, 0, 0, DateTimeKind.Utc),
                            DataCorrida = new DateTime(2026, 3, 28, 0, 0, 0, 0, DateTimeKind.Utc),
                            Distancia = "307.5 km",
                            Encerrada = false,
                            LembreteEnviado = false,
                            LembreteUrgenteEnviado = false,
                            ...
                            Numero = 4,
                            Pais = "jp",
                            PrazoQualify = new DateTime(2026, 3, 28, 0, 0, 0, 0, DateTimeKind.Utc),
                            Recordista = "Lewis Hamilton",
                            SemanaEnviada = false,
                            Sprint = false,
                            TempoRecord = "1:30.983",
                            TreinoLivre1 = new DateTime(2026, 3, 26, 0, 30, 0, 0, DateTimeKind.Utc),
                            TreinoLivre2 = new DateTime(2026, 3, 26, 4, 0, 0, 0, DateTimeKind.Utc),
                            TreinoLivre3 = new DateTime(2026, 3, 27, 0, 30, 0, 0, DateTimeKind.Utc),
                            Voltas = 53
                        },
                        new
                        {
                            ...
                            Classificacao = new DateTime(2026, 4, 10, 13, 0, 0, 0, DateTimeKind.Utc),
                            DataCorrida = new DateTime(2026, 4, 11, 9, 0, 0, 0, DateTimeKind.Utc),
                            Distancia = "308.2 km",
                            Encerrada = false,
                            LembreteEnviado = false,
                            LembreteUrgenteEnviado = false,
                            ...
                            Numero = 5,
                            Pais = "bh",
                            PrazoQualify = new DateTime(2026, 4, 11, 9, 0, 0, 0, DateTimeKind.Utc),
                            Recordista = "Pedro de la Rosa",
                            SemanaEnviada = false,
                            Sprint = false,
                            TempoRecord = "1:30.252",
                            TreinoLivre1 = new DateTime(2026, 4, 9, 9, 30, 0, 0, DateTimeKind.Utc),
                            TreinoLivre2 = new DateTime(2026, 4, 9, 13, 0, 0, 0, DateTimeKind.Utc),
                            TreinoLivre3 = new DateTime(2026, 4, 10, 9, 30, 0, 0, DateTimeKind.Utc),
                            Voltas = 57
                        },
                        new
                        {
                            ...
                            Classificacao = new DateTime(2026, 4, 17, 15, 0, 0, 0, DateTimeKind.Utc),
                            DataCorrida = new DateTime(2026, 4, 18, 11, 0, 0, 0, DateTimeKind.Utc),
                            Distancia = "308.5 km",
                            Encerrada = false,
                            LembreteEnviado = false,
                            LembreteUrgenteEnviado = false,
                            ...
                            Numero = 6,
                            Pais = "sa",
                            PrazoQualify = new DateTime(2026, 4, 18, 11, 0, 0, 0, DateTimeKind.Utc),
                            Recordista = "Sergio Perez",
                            SemanaEnviada = false,
                            Sprint = false,
                            TempoRecord = "1:30.734",
                            TreinoLivre1 = new DateTime(2026, 4, 16, 11, 30, 0, 0, DateTimeKind.Utc),
                            TreinoLivre2 = new DateTime(2026, 4, 16, 15, 0, 0, 0, DateTimeKind.Utc),
                            TreinoLivre3 = new DateTime(2026, 4, 17, 11, 30, 0, 0, DateTimeKind.Utc),
                            Voltas = 50
                        },
                        new
                        {
                            ...
                            CircuitoTipo = "Circuito semi-permanente",
                            Classificacao = new DateTime(2026, 4, 30, 18, 30, 0, 0, DateTimeKind.Utc),
                            DataCorrida = new DateTime(2026, 5, 1, 14, 30, 0, 0, DateTimeKind.Utc),
                            Distancia = "97.4 km",
                            Encerrada = false,
                            LembreteEnviado = false,
                            LembreteUrgenteEnviado = false,
                            ...
                            Numero = 7,
                            Pais = "us",
                            PrazoQualify = new DateTime(2026, 5, 1, 14, 30, 0, 0, DateTimeKind.Utc),
                            Recordista = "Max Verstappen",
                            SemanaEnviada = false,
                            Sprint = true,
                            TempoRecord = "1:27.274",
                            TreinoLivre1 = new DateTime(2026, 4, 30, 15, 0, 0, 0, DateTimeKind.Utc),
                            Voltas = 18
                        },
                        new
                        {
                            ...
                            CircuitoSvg = "<svg width=\"500\" height=\"500\" xml:space=\"preserve\" xmlns=\"http://www.w3.org/2000/svg\"> <path style=\"fill: none; stroke: currentColor; stroke-width: 20; stroke-linejoin: round; stroke-dasharray: none; stroke-opacity: 1;\" d=\"M253.178 217.953s37.841 21.485 43.997 24.88c6.096 3.396 9.778 7.26 9.597 9.835-.182 2.518-2.777 5.913-5.613 7.61-2.777 1.698-7.665 4.04-9.596 6.616-1.932 2.517-3.501 4.566-3.682 11.006-.181 6.44-.181 11.532-1.57 15.396-1.146 3.161-5.25 10.479-19.312 15.22-13.64 4.567-17.925 3.513-29.211 3.22-10.441-.292-20.762-5.912-20.762-5.912s-53.774-29.622-58.965-32.49c-5.25-2.87-13.64-4.391-20.4-2.87-7 1.523-8.81 2.928-12.734 5.738-3.259 2.342-8.027 5.913-12.553 6.44-4.527.526-10.2.234-14.666-1.698-4.044-1.756-9.415-7.142-12.01-9.835-2.595-2.693-8.148-6.264-16.054-6.44-6.458-.175-20.64 1.347-28.789 10.713-3.38 3.864-5.854 6.85-5.854 14.284 0 5.503 5.19 12.88 10.2 12.938 10.2.176 7.725-1.288 15.51-1.522 9.597-.293 13.64.702 19.012 2.693 5.371 1.99 20.218 5.503 28.124 5.561 10.502.117 73.692-1.17 77.856-1.17 10.38-.06 18.83 2.048 25.107 4.741 6.277 2.693 19.192 8.606 24.443 10.128 5.25 1.522 14.666 5.093 28.97 4.917 14.303-.175 39.953-1.697 54.438-6.79 14.485-5.094 60.051-20.139 72.967-25.583 12.916-5.444 39.29-18.03 44.661-21.485 3.38-2.166 5.432-3.395 5.613-6.44.181-3.043-4.888-6.439-7.484-7.61-2.595-1.17-4.466-1.931-7.664-4.566-3.5-2.868-5.13-6.146-5.13-9.717 0-6.616 4.526-11.475 10.018-11.65 3.5-.117 14.183.175 17.14-.351 2.958-.527 7.303-2.05 9.597-5.562 2.293-3.512 4.949-8.722 5.794-10.01 1.448-2.166 1.026-3.396-1.57-4.567-2.595-1.17-4.043-3.044-2.776-6.615 1.268-3.57 3.742-13.347 4.225-15.923.422-2.4-.181-5.561-3.863-5.561-4.707 0-118.654-4.215-132.777-4.567-14.364-.234-209.968-7.61-232.963-8.898-7.242-.41-8.932 3.805-8.45 5.971.906 4.04 11.166 10.655 17.443 14.226 6.276 3.57 8.57 4.39 16.054 4.742 7.483.35 11.89-1.698 16.054-4.215 4.164-2.518 12.734-7.26 22.873-9.484 7.182-1.58 20.4-1.288 25.47-.527 7.181 1.112 14.303 4.04 20.76 7.61 6.459 3.572 48.525 27.573 48.525 27.573z\" /> </svg>",
                            CircuitoTipo = "Circuito semi-permanente",
                            Classificacao = new DateTime(2026, 5, 1, 18, 30, 0, 0, DateTimeKind.Utc),
                            DataCorrida = new DateTime(2026, 5, 2, 14, 0, 0, 0, DateTimeKind.Utc),
                            Distancia = "308.3 km",
                            Encerrada = false,
                            LembreteEnviado = false,
                            LembreteUrgenteEnviado = false,
                            ...
                            Numero = 8,
                            Pais = "us",
                            PrazoQualify = new DateTime(2026, 5, 2, 14, 0, 0, 0, DateTimeKind.Utc),
                            Recordista = "Max Verstappen",
                            SemanaEnviada = false,
                            Sprint = false,
                            TempoRecord = "1:27.274",
                        ...
                        new
                        {
                            ...
                            CircuitoTipo = "Circuito semi-permanente",
                            Classificacao = new DateTime(2026, 5, 21, 18, 30, 0, 0, DateTimeKind.Utc),
                            DataCorrida = new DateTime(2026, 5, 22, 14, 30, 0, 0, DateTimeKind.Utc),
                            Distancia = "100.3 km",
                            Encerrada = false,
                            LembreteEnviado = false,
                            LembreteUrgenteEnviado = false,
                            ...
                            Numero = 9,
                            Pais = "ca",
                            PrazoQualify = new DateTime(2026, 5, 22, 14, 30, 0, 0, DateTimeKind.Utc),
                            Recordista = "Valtteri Bottas",
                            SemanaEnviada = false,
                            Sprint = true,
                            TempoRecord = "1:13.078",
                            TreinoLivre1 = new DateTime(2026, 5, 21, 15, 0, 0, 0, DateTimeKind.Utc),
                            Voltas = 23
                        },
                        new
                        {
                            ...
                            CircuitoSvg = "<svg width=\"500\" height=\"500\" xml:space=\"preserve\" xmlns=\"http://www.w3.org/2000/svg\"> <path style=\"fill: none; stroke: currentColor; stroke-width: 20; stroke-linejoin: round; stroke-dasharray: none; stroke-opacity: 1;\" d=\"M223.071 47.18c-2.536-11.336-4.35-19.461-5.519-25.208-.965-4.748 1.315-6.378 3.73-6.861 2.237-.448 4.69 1.63 5.07 6.115.597 7.01 1.045 10.441 1.641 16.11.352 3.346 1.416 7.836 4.624 14.468 2.238 4.624 6.862 13.871 12.679 28.638 2.265 5.75 12.827 32.666 15.512 39.676 1.843 4.812 4.475 14.32 5.52 20.137 1.043 5.817 24.312 118.88 31.173 151.843 1.025 4.926-1.742 6.349-2.983 7.01-2.237 1.194-3.729 2.686-2.834 7.757s18.197 84.722 19.39 90.39c1.194 5.668 3.282 16.259 2.835 27.744-.355 9.096-1.936 29.235-2.387 33.411-.596 5.52-.596 7.16 2.387 8.353 2.983 1.193 4.039 1.614 6.861 2.834 11.038 4.773 2.983 17.004-4.773 15.065-8.494-2.123-13.458-3.632-23.269-7.16-13.275-4.772-33.56-23.865-41.764-31.92-3.538-3.473-2.834-7.606-1.044-10.888 1.79-3.281 1.26-5.254-1.343-9.397-3.281-5.22-12.411-17.275-15.512-20.136-3.878-3.58-7.56-5.592-11.187-7.906-7.01-4.475-12.53-14.02-12.53-23.268 0-7.017.597-31.622.746-36.544.15-4.923-1.496-8.826-6.264-9.1-5.22-.297-10.143 3.58-14.916.3-4.773-3.282-7.866-5.35-9.696-15.662-3.281-18.496-5.518-40.273-5.37-52.206.127-10.143 1.776-35.995 4.923-50.416 1.79-8.203 8.502-34.455 10.143-39.527 1.133-3.505 3.878-4.624 7.458-4.325 5.37.447 10.292-2.983 12.827-11.635 2.974-10.145 9.546-34.754 10.441-41.167.924-6.623 5.074-31.195 5.221-40.72.15-9.696-.1-18.247-1.79-25.805z\" /> </svg>",
                            CircuitoTipo = "Circuito semi-permanente",
                            Classificacao = new DateTime(2026, 5, 22, 18, 30, 0, 0, DateTimeKind.Utc),
                            DataCorrida = new DateTime(2026, 5, 23, 14, 0, 0, 0, DateTimeKind.Utc),
                            Distancia = "305.3 km",
                            Encerrada = false,
                            LembreteEnviado = false,
                            LembreteUrgenteEnviado = false,
                            ...
                            Numero = 10,
                            Pais = "ca",
                            PrazoQualify = new DateTime(2026, 5, 23, 14, 0, 0, 0, DateTimeKind.Utc),
                            Recordista = "Valtteri Bottas",
                            SemanaEnviada = false,
                            Sprint = false,
                            TempoRecord = "1:13.078",
                        ...
                        new
                        {
                            ...
                            CircuitoTipo = "Circuito de rua",
                            Classificacao = new DateTime(2026, 6, 5, 12, 0, 0, 0, DateTimeKind.Utc),
                            DataCorrida = new DateTime(2026, 6, 6, 8, 0, 0, 0, DateTimeKind.Utc),
                            Distancia = "260.3 km",
                            Encerrada = false,
                            LembreteEnviado = false,
                            LembreteUrgenteEnviado = false,
                            ...
                            Numero = 11,
                            Pais = "mc",
                            PrazoQualify = new DateTime(2026, 6, 6, 8, 0, 0, 0, DateTimeKind.Utc),
                            Recordista = "Charles Leclerc",
                            SemanaEnviada = false,
                            Sprint = false,
                            TempoRecord = "1:12.909",
                            TreinoLivre1 = new DateTime(2026, 6, 4, 8, 30, 0, 0, DateTimeKind.Utc),
                            TreinoLivre2 = new DateTime(2026, 6, 4, 12, 0, 0, 0, DateTimeKind.Utc),
                            TreinoLivre3 = new DateTime(2026, 6, 5, 8, 30, 0, 0, DateTimeKind.Utc),
                            Voltas = 78
                        },
                        new
                        {
                            ...
                            CircuitoTipo = "Circuito permanente",
                            Classificacao = new DateTime(2026, 6, 12, 12, 0, 0, 0, DateTimeKind.Utc),
                            DataCorrida = new DateTime(2026, 6, 13, 8, 0, 0, 0, DateTimeKind.Utc),
                            Distancia = "307.3 km",
                            Encerrada = false,
                            LembreteEnviado = false,
                            LembreteUrgenteEnviado = false,
                            ...
                            Numero = 12,
                            Pais = "es",
                            PrazoQualify = new DateTime(2026, 6, 13, 8, 0, 0, 0, DateTimeKind.Utc),
                            Recordista = "Max Verstappen",
                            SemanaEnviada = false,
                            Sprint = false,
                            TempoRecord = "1:16.330",
                            TreinoLivre1 = new DateTime(2026, 6, 11, 8, 30, 0, 0, DateTimeKind.Utc),
                            TreinoLivre2 = new DateTime(2026, 6, 11, 12, 0, 0, 0, DateTimeKind.Utc),
                            TreinoLivre3 = new DateTime(2026, 6, 12, 8, 30, 0, 0, DateTimeKind.Utc),
                            Voltas = 66
                        },
                        new
                        {
                            ...
                            CircuitoTipo = "Circuito permanente",
                            Classificacao = new DateTime(2026, 6, 26, 12, 0, 0, 0, DateTimeKind.Utc),
                            DataCorrida = new DateTime(2026, 6, 27, 8, 0, 0, 0, DateTimeKind.Utc),
                            Distancia = "306.5 km",
                            Encerrada = false,
                            LembreteEnviado = false,
                            LembreteUrgenteEnviado = false,
                            ...
                            Numero = 13,
                            Pais = "at",
                            PrazoQualify = new DateTime(2026, 6, 27, 8, 0, 0, 0, DateTimeKind.Utc),
                            Recordista = "Carlos Sainz",
                            SemanaEnviada = false,
                            Sprint = false,
                            TempoRecord = "1:05.619",
                            TreinoLivre1 = new DateTime(2026, 6, 25, 8, 30, 0, 0, DateTimeKind.Utc),
                            TreinoLivre2 = new DateTime(2026, 6, 25, 12, 0, 0, 0, DateTimeKind.Utc),
                            TreinoLivre3 = new DateTime(2026, 6, 26, 8, 30, 0, 0, DateTimeKind.Utc),
                            Voltas = 71
                        },
                        new
                        {
                            ...
                            CircuitoTipo = "Circuito permanente",
                            Classificacao = new DateTime(2026, 7, 2, 13, 30, 0, 0, DateTimeKind.Utc),
                            DataCorrida = new DateTime(2026, 7, 3, 9, 30, 0, 0, DateTimeKind.Utc),
                            Distancia = "100.1 km",
                            Encerrada = false,
                            LembreteEnviado = false,
                            LembreteUrgenteEnviado = false,
                            ...
                            Numero = 14,
                            Pais = "gb",
                            PrazoQualify = new DateTime(2026, 7, 3, 9, 30, 0, 0, DateTimeKind.Utc),
                            Recordista = "Lewis Hamilton",
                            SemanaEnviada = false,
                            Sprint = true,
                            TempoRecord = "1:24.303",
                            TreinoLivre1 = new DateTime(2026, 7, 2, 10, 0, 0, 0, DateTimeKind.Utc),
                            Voltas = 17
                        },
                        new
                        {
                            ...
                            CircuitoSvg = "<svg width=\"500\" height=\"500\" xml:space=\"preserve\" xmlns=\"http://www.w3.org/2000/svg\"> <path style=\"fill: none; stroke: currentColor; stroke-width: 20; stroke-linejoin: round; stroke-dasharray: none; stroke-opacity: 1;\" d=\"M187.132 258.577c2.83-3.815 6.413-9.565 13.577-10.593 13.554-1.944 21.828 1.404 35.111 3.348 16.012 2.344 24.823-.431 33.316-6.912 16.091-12.281 27.87-21.819 38.54-30.677 7.154-5.938 13.066-1.296 14.154 3.024 1.523 6.05 2.831 11.45 6.969 24.844 1.656 5.362 9.362 7.346 12.628.432 5.003-10.589 6.313-15.666 7.839-21.819 5.617-22.642-.695-28.128-2.83-30.029-29.832-26.571-120.874-108.733-128.253-115.577-10.017-9.29-28.416-4.536-29.233 4.861-.816 9.398-.899 12.315-1.306 17.985-.25 3.466-7.266 17.717-20.74 12.8-14.209-5.185-7.879-20.646-7.325-21.701 7.29-13.886 15.623-29.211 20.505-37.048 9.58-15.378 25.704-25.296 39.407-26.584 18.917-1.78 76.237-6.805 105.634-9.258 2.916-.243 5.556-.498 7.862-.65 7.843-.516 21.345 4.846 24.827 16.658 8.166 27.706 12.928 43.496 14.332 67.407 1.269 21.603 2.421 42.276 2.653 49.736.278 8.92 1.882 13.375 9.635 24.627.68.984 1.46 2.099 2.315 3.333 2.182 3.148 3.236 7.36-.247 16.434-3.793 9.88-9.554 20.467-9.145 29.812.546 12.475 4.325 13.683 9.363 19.66 10.017 11.882 7.186 25.707-4.62 32.755-4.323 2.58-8.564 4.969-12.364 7.211-9.437 5.57-13.513 9.501-18.29 19.28-12.957 26.518-83.893 152.682-99.075 173.203-12.588 17.013-38.433 10.532-43.659-6.643-1.42-4.666-16.26-30.392-20.577-34.403-10.234-9.505-16.766-16.417-20.25-21.17-3.42-4.668-7.676-9.398-13.882-17.337-2.815-3.6-6.621-5.117-10.615-.81-3.291 3.549-5.422 5.822-7.408 7.183-2.547 1.745-8.378 1.89-11.644-1.998-1.713-2.04-10.749-12.65-14.154-22.035-3.919-10.802-5.688-12.142 5.771-27.113 10.997-14.365 52.26-67.725 59.227-76.475 2.784-3.497 7.22-9.384 11.952-15.761z\" /> </svg>",
                            CircuitoTipo = "Circuito permanente",
                            Classificacao = new DateTime(2026, 7, 3, 13, 30, 0, 0, DateTimeKind.Utc),
                            DataCorrida = new DateTime(2026, 7, 4, 9, 0, 0, 0, DateTimeKind.Utc),
                            Distancia = "306.2 km",
                            Encerrada = false,
                            LembreteEnviado = false,
                            LembreteUrgenteEnviado = false,
                            ...
                            Numero = 15,
                            Pais = "gb",
                            PrazoQualify = new DateTime(2026, 7, 4, 9, 0, 0, 0, DateTimeKind.Utc),
                            Recordista = "Lewis Hamilton",
                            SemanaEnviada = false,
                            Sprint = false,
                            TempoRecord = "1:24.303",
                        ...
                        new
                        {
                            ...
                            CircuitoTipo = "Circuito permanente",
                            Classificacao = new DateTime(2026, 7, 17, 12, 0, 0, 0, DateTimeKind.Utc),
                            DataCorrida = new DateTime(2026, 7, 18, 8, 0, 0, 0, DateTimeKind.Utc),
                            Distancia = "308.1 km",
                            Encerrada = false,
                            LembreteEnviado = false,
                            LembreteUrgenteEnviado = false,
                            ...
                            Numero = 16,
                            Pais = "be",
                            PrazoQualify = new DateTime(2026, 7, 18, 8, 0, 0, 0, DateTimeKind.Utc),
                            Recordista = "Valtteri Bottas",
                            SemanaEnviada = false,
                            Sprint = false,
                            TempoRecord = "1:46.286",
                            TreinoLivre1 = new DateTime(2026, 7, 16, 8, 30, 0, 0, DateTimeKind.Utc),
                            TreinoLivre2 = new DateTime(2026, 7, 16, 12, 0, 0, 0, DateTimeKind.Utc),
                            TreinoLivre3 = new DateTime(2026, 7, 17, 8, 30, 0, 0, DateTimeKind.Utc),
                            Voltas = 44
                        },
                        new
                        {
                            ...
                            CircuitoTipo = "Circuito permanente",
                            Classificacao = new DateTime(2026, 7, 24, 12, 0, 0, 0, DateTimeKind.Utc),
                            DataCorrida = new DateTime(2026, 7, 25, 8, 0, 0, 0, DateTimeKind.Utc),
                            Distancia = "306.6 km",
                            Encerrada = false,
                            LembreteEnviado = false,
                            LembreteUrgenteEnviado = false,
                            ...
                            Numero = 17,
                            Pais = "hu",
                            PrazoQualify = new DateTime(2026, 7, 25, 8, 0, 0, 0, DateTimeKind.Utc),
                            Recordista = "Lewis Hamilton",
                            SemanaEnviada = false,
                            Sprint = false,
                            TempoRecord = "1:16.627",
                            TreinoLivre1 = new DateTime(2026, 7, 23, 8, 30, 0, 0, DateTimeKind.Utc),
                            TreinoLivre2 = new DateTime(2026, 7, 23, 12, 0, 0, 0, DateTimeKind.Utc),
                            TreinoLivre3 = new DateTime(2026, 7, 24, 8, 30, 0, 0, DateTimeKind.Utc),
                            Voltas = 70
                        },
                        new
                        {
                            ...
                            CircuitoTipo = "Circuito permanente",
                            Classificacao = new DateTime(2026, 8, 20, 12, 30, 0, 0, DateTimeKind.Utc),
                            DataCorrida = new DateTime(2026, 8, 21, 8, 30, 0, 0, DateTimeKind.Utc),
                            Distancia = "102.2 km",
                            Encerrada = false,
                            LembreteEnviado = false,
                            LembreteUrgenteEnviado = false,
                            ...
                            Numero = 18,
                            Pais = "nl",
                            PrazoQualify = new DateTime(2026, 8, 21, 8, 30, 0, 0, DateTimeKind.Utc),
                            Recordista = "Max Verstappen",
                            SemanaEnviada = false,
                            Sprint = true,
                            TempoRecord = "1:11.097",
                            TreinoLivre1 = new DateTime(2026, 8, 20, 9, 0, 0, 0, DateTimeKind.Utc),
                            Voltas = 24
                        },
                        new
                        {
                            ...
                            CircuitoSvg = "<svg width=\"500\" height=\"500\" xml:space=\"preserve\" xmlns=\"http://www.w3.org/2000/svg\"> <path style=\"fill: none; stroke: currentColor; stroke-width: 20; stroke-linejoin: round; stroke-dasharray: none; stroke-opacity: 1;\" d=\"M21.069 357.833c1.298-3.172 2.643-6.403 4.005-9.703 39.95-96.747 102.157-247.306 119.655-289.933 3.898-9.5 13.163-13.63 23.395-9.5 7.133 2.878 10.938 7.388 12.269 15.545 1.314 8.052-2.023 13.112-5.136 22.264-4.375 12.858-8.062 21.928-13.314 34.737-4.565 11.131-8.748 22.264-9.13 36.082-.372 13.554-.299 18.144-.57 23.607-.57 11.515-4.946 18.903-18.07 23.797-11.036 4.116-19.445 6.953-26.765 9.625-1.385.507-21.738 7.073-16.317 23.482 6.249 18.915 23.516 12.476 24.897 12.061 15.203-4.553 47.601-15.05 61.552-19.45 10.043-3.166 34.618-2.687 52.782 1.92 11.556 2.929 31.293 9.03 49.644 9.5 18.735.48 49.833-20.823 58.678-27.156 8.845-6.334 25.772-12.533 39.469-11.994 21.969.863 51.066 3.037 60.96 3.742 13.506.96 37.51 9.447 43.938 33.01 5.706 20.919-1.52 36.273-8.178 46.158-8.541 12.678-20.542 29.076-26.249 40.016-3.437 6.589-12.174 24.375-19.503 39.417-4.837 9.93-9.028 16.623-32.613 14.32-11.761-1.15-36.85-4.875-62.578-28.019-8.75-7.87-7.989-18.233-4.755-22.07 6.896-8.183 14.836-12.283 23.396-13.434 21.706-2.92 24.918-2.303 53.638-13.243 13.996-5.329 17.746-17.038 15.788-27.636-2.093-11.325-9.892-17.658-23.777-19.577-42.12-5.824-79.576-3.528-110.13 2.304-42.225 8.06-79.517 23.968-116.977 43.373-14.076 7.294-15.977-1.727-20.16-10.364-3.746-7.729-11.831-9.875-19.213-7.87-9.89 2.688-12.487 9.57-11.601 15.162 2.853 18.04 16.166 95.962 20.16 117.456 3.164 17.024-2.852 36.465-27.77 37.234-15.79.488-29.415.122-50.785-2.879-15.026-2.11-34.119-17.863-40.896-34.546-4.754-11.709-10.841-30.324.26-57.438Z\" /> </svg>",
                            CircuitoTipo = "Circuito permanente",
                            Classificacao = new DateTime(2026, 8, 21, 12, 30, 0, 0, DateTimeKind.Utc),
                            DataCorrida = new DateTime(2026, 8, 22, 8, 0, 0, 0, DateTimeKind.Utc),
                            Distancia = "306.6 km",
                            Encerrada = false,
                            LembreteEnviado = false,
                            LembreteUrgenteEnviado = false,
                            ...
                            Numero = 19,
                            Pais = "nl",
                            PrazoQualify = new DateTime(2026, 8, 22, 8, 0, 0, 0, DateTimeKind.Utc),
                            Recordista = "Max Verstappen",
                            SemanaEnviada = false,
                            Sprint = false,
                            TempoRecord = "1:11.097",
                        ...
                        new
                        {
                            ...
                            Classificacao = new DateTime(2026, 9, 4, 12, 0, 0, 0, DateTimeKind.Utc),
                            DataCorrida = new DateTime(2026, 9, 5, 8, 0, 0, 0, DateTimeKind.Utc),
                            Distancia = "306.7 km",
                            Encerrada = false,
                            LembreteEnviado = false,
                            LembreteUrgenteEnviado = false,
                            ...
                            Numero = 20,
                            Pais = "it",
                            PrazoQualify = new DateTime(2026, 9, 5, 8, 0, 0, 0, DateTimeKind.Utc),
                            Recordista = "Rubens Barrichello",
                            SemanaEnviada = false,
                            Sprint = false,
                            TempoRecord = "1:21.046",
                            TreinoLivre1 = new DateTime(2026, 9, 3, 8, 30, 0, 0, DateTimeKind.Utc),
                            TreinoLivre2 = new DateTime(2026, 9, 3, 12, 0, 0, 0, DateTimeKind.Utc),
                            TreinoLivre3 = new DateTime(2026, 9, 4, 8, 30, 0, 0, DateTimeKind.Utc),
                            Voltas = 53
                        },
                        new
                        {
                            ...
                            CircuitoTipo = "Circuito semi-permanente",
                            Classificacao = new DateTime(2026, 9, 11, 12, 0, 0, 0, DateTimeKind.Utc),
                            DataCorrida = new DateTime(2026, 9, 12, 8, 0, 0, 0, DateTimeKind.Utc),
                            Distancia = "306.5 km",
                            Encerrada = false,
                            LembreteEnviado = false,
                            LembreteUrgenteEnviado = false,
                            ...
                            Numero = 21,
                            Pais = "es",
                            PrazoQualify = new DateTime(2026, 9, 12, 8, 0, 0, 0, DateTimeKind.Utc),
                            Recordista = "—",
                            SemanaEnviada = false,
                            Sprint = false,
                            TempoRecord = "—",
                            TreinoLivre1 = new DateTime(2026, 9, 10, 8, 30, 0, 0, DateTimeKind.Utc),
                            TreinoLivre2 = new DateTime(2026, 9, 10, 12, 0, 0, 0, DateTimeKind.Utc),
                            TreinoLivre3 = new DateTime(2026, 9, 11, 8, 30, 0, 0, DateTimeKind.Utc),
                            Voltas = 56
                        },
                        new
                        {
                            ...
                            CircuitoTipo = "Circuito de rua",
                            Classificacao = new DateTime(2026, 9, 24, 10, 0, 0, 0, DateTimeKind.Utc),
                            DataCorrida = new DateTime(2026, 9, 25, 6, 0, 0, 0, DateTimeKind.Utc),
                            Distancia = "306.0 km",
                            Encerrada = false,
                            LembreteEnviado = false,
                            LembreteUrgenteEnviado = false,
                            ...
                            Numero = 22,
                            Pais = "az",
                            PrazoQualify = new DateTime(2026, 9, 25, 6, 0, 0, 0, DateTimeKind.Utc),
                            Recordista = "Charles Leclerc",
                            SemanaEnviada = false,
                            Sprint = false,
                            TempoRecord = "1:43.009",
                            TreinoLivre1 = new DateTime(2026, 9, 23, 6, 30, 0, 0, DateTimeKind.Utc),
                            TreinoLivre2 = new DateTime(2026, 9, 23, 10, 0, 0, 0, DateTimeKind.Utc),
                            TreinoLivre3 = new DateTime(2026, 9, 24, 6, 30, 0, 0, DateTimeKind.Utc),
                            Voltas = 51
                        },
                        new
                        {
                            ...
                            Classificacao = new DateTime(2026, 10, 8, 10, 30, 0, 0, DateTimeKind.Utc),
                            DataCorrida = new DateTime(2026, 10, 9, 6, 30, 0, 0, DateTimeKind.Utc),
                            Distancia = "103.7 km",
                            Encerrada = false,
                            LembreteEnviado = false,
                            LembreteUrgenteEnviado = false,
                            ...
                            Numero = 23,
                            Pais = "sg",
                            PrazoQualify = new DateTime(2026, 10, 9, 6, 30, 0, 0, DateTimeKind.Utc),
                            Recordista = "Lewis Hamilton",
                            SemanaEnviada = false,
                            Sprint = true,
                            TempoRecord = "1:35.867",
                            TreinoLivre1 = new DateTime(2026, 10, 8, 7, 0, 0, 0, DateTimeKind.Utc),
                            Voltas = 21
                        },
                        new
                        {
                            ...
                            CircuitoSvg = "<svg width=\"500\" height=\"500\" xml:space=\"preserve\" xmlns=\"http://www.w3.org/2000/svg\"> <path style=\"fill: none; stroke: currentColor; stroke-width: 20; stroke-linejoin: round; stroke-dasharray: none; stroke-opacity: 1;\" d=\"M461.432 325.308c3.546.215 6.228-.46 8.285-3.467 2.658-3.883 10.644-15.694 13.506-20.689 2.248-3.924 1.906-8.228 1.362-12.25-.547-4.022-21.779-162.674-22.394-167.042-.55-3.905-2.982-6.455-8.02-5.625-5.037.832-10.535.682-15.509-2.08-5.826-3.236-7.566-5.548-9.382-9.324-2.012-4.185-5.031-6.738-7.791-6.78-4.919-.079-7.416 3.389-7.87 6.78-.944 7.05-1.516 14.7-1.89 19.263-.454 5.547.59 16.212 1.816 20.65 1.226 4.438 6.726 21.596 9.38 32.207 2.657 10.608 5.068 21.644 6.355 28.2 1.816 9.246-5.447 26.66-19.82 25.58-16.56-1.243-96.96-6.878-104.994-7.571-7.76-.67-17.023-1.387-24.511-4.784-9.874-4.479-92.876-54.296-99.618-58.388-4.267-2.589-5.307-2.724-7.762 1.528-11.374 19.692-20.682 35.827-31.12 56.305-1.838 3.606-3.541 4.266-6.334 1.284-4.19-4.477-26.419-27.808-32.683-34.534-5.78-6.204-20.57-6.21-25.67 4.612-6.504 13.799-56.755 104.28-59.206 108.974-1.382 2.644-2.983 6.481-2.427 10.392.47 3.318 2.756 6.781 5.287 8.641 3.575 2.63 8.469 6.402 12.552 9.457 2.35 1.759 5.615 2.859 10.003 3.783 3.281.692 4.549 2.145 4.69 10.942.077 4.74.304 10.324.304 14.178 0 5.64 3.442 6.28 6.278 8.59 8.916 7.264 16.457 13.176 21.79 17.106 1.07.79 6.672 4.662 8.285 7.396 3.404 5.78 5.447 8.784 7.15 11.096 2.722 3.694 7.75 2.688 8.625-2.08 1.93-10.519 14.526-87.49 17.477-105.29.646-3.9 2.514-10.388 3.065-11.788.098-.25 17.789-43.744 18.355-45.218.646-1.68 1.17-2.659 1.277-2.918 1.153-2.766 3.802-3.986 7.49-.75 5.372 4.713 45.155 39.55 51.182 44.959 5.529 4.963 13.647 8.282 20.848 8.815 2.986.222 39.063 1.437 74.063 3.358 33.248 1.827 65.538 4.368 67.03 4.47 3.065.208 6.169 2.43 6.129 6.819-.115 12.367 4.653 19.533 14.98 20.457 5.903.526 74.874 4.459 79.437 4.736z\" /> </svg>",
                            CircuitoTipo = "Circuito de rua (noturno)",
                            Classificacao = new DateTime(2026, 10, 9, 11, 30, 0, 0, DateTimeKind.Utc),
                            DataCorrida = new DateTime(2026, 10, 10, 7, 0, 0, 0, DateTimeKind.Utc),
                            Distancia = "306.1 km",
                            Encerrada = false,
                            LembreteEnviado = false,
                            LembreteUrgenteEnviado = false,
                            ...
                            Numero = 24,
                            Pais = "sg",
                            PrazoQualify = new DateTime(2026, 10, 10, 7, 0, 0, 0, DateTimeKind.Utc),
                            Recordista = "Lewis Hamilton",
                            SemanaEnviada = false,
                            Sprint = false,
                            TempoRecord = "1:35.867",
                        ...
                        new
                        {
                            ...
                            CircuitoTipo = "Circuito permanente",
                            Classificacao = new DateTime(2026, 10, 23, 19, 0, 0, 0, DateTimeKind.Utc),
                            DataCorrida = new DateTime(2026, 10, 24, 15, 0, 0, 0, DateTimeKind.Utc),
                            Distancia = "308.4 km",
                            Encerrada = false,
                            LembreteEnviado = false,
                            LembreteUrgenteEnviado = false,
                            ...
                            Numero = 25,
                            Pais = "us",
                            PrazoQualify = new DateTime(2026, 10, 24, 15, 0, 0, 0, DateTimeKind.Utc),
                            Recordista = "Charles Leclerc",
                            SemanaEnviada = false,
                            Sprint = false,
                            TempoRecord = "1:36.169",
                            TreinoLivre1 = new DateTime(2026, 10, 22, 15, 30, 0, 0, DateTimeKind.Utc),
                            TreinoLivre2 = new DateTime(2026, 10, 22, 19, 0, 0, 0, DateTimeKind.Utc),
                            TreinoLivre3 = new DateTime(2026, 10, 23, 15, 30, 0, 0, DateTimeKind.Utc),
                            Voltas = 56
                        },
                        new
                        {
                            ...
                            Classificacao = new DateTime(2026, 10, 30, 19, 0, 0, 0, DateTimeKind.Utc),
                            DataCorrida = new DateTime(2026, 10, 31, 15, 0, 0, 0, DateTimeKind.Utc),
                            Distancia = "305.4 km",
                            Encerrada = false,
                            LembreteEnviado = false,
                            LembreteUrgenteEnviado = false,
                            ...
                            Numero = 26,
                            Pais = "mx",
                            PrazoQualify = new DateTime(2026, 10, 31, 15, 0, 0, 0, DateTimeKind.Utc),
                            Recordista = "Valtteri Bottas",
                            SemanaEnviada = false,
                            Sprint = false,
                            TempoRecord = "1:17.774",
                            TreinoLivre1 = new DateTime(2026, 10, 29, 15, 30, 0, 0, DateTimeKind.Utc),
                            TreinoLivre2 = new DateTime(2026, 10, 29, 19, 0, 0, 0, DateTimeKind.Utc),
                            TreinoLivre3 = new DateTime(2026, 10, 30, 15, 30, 0, 0, DateTimeKind.Utc),
                            Voltas = 71
                        },
                        new
                        {
                            ...
                            CircuitoTipo = "Circuito permanente",
                            Classificacao = new DateTime(2026, 11, 6, 16, 0, 0, 0, DateTimeKind.Utc),
                            DataCorrida = new DateTime(2026, 11, 7, 12, 0, 0, 0, DateTimeKind.Utc),
                            Distancia = "305.9 km",
                            Encerrada = false,
                            LembreteEnviado = false,
                            LembreteUrgenteEnviado = false,
                            ...
                            Numero = 27,
                            Pais = "br",
                            PrazoQualify = new DateTime(2026, 11, 7, 12, 0, 0, 0, DateTimeKind.Utc),
                            Recordista = "Valtteri Bottas",
                            SemanaEnviada = false,
                            Sprint = false,
                            TempoRecord = "1:10.540",
                            TreinoLivre1 = new DateTime(2026, 11, 5, 12, 30, 0, 0, DateTimeKind.Utc),
                            TreinoLivre2 = new DateTime(2026, 11, 5, 16, 0, 0, 0, DateTimeKind.Utc),
                            TreinoLivre3 = new DateTime(2026, 11, 6, 12, 30, 0, 0, DateTimeKind.Utc),
                            Voltas = 71
                        },
                        new
                        {
                            ...
                            CircuitoTipo = "Circuito de rua (noturno)",
                            Classificacao = new DateTime(2026, 11, 20, 2, 0, 0, 0, DateTimeKind.Utc),
                            DataCorrida = new DateTime(2026, 11, 20, 22, 0, 0, 0, DateTimeKind.Utc),
                            Distancia = "310.0 km",
                            Encerrada = false,
                            LembreteEnviado = false,
                            LembreteUrgenteEnviado = false,
                            ...
                            Numero = 28,
                            Pais = "us",
                            PrazoQualify = new DateTime(2026, 11, 20, 22, 0, 0, 0, DateTimeKind.Utc),
                            Recordista = "Max Verstappen",
                            SemanaEnviada = false,
                            Sprint = false,
                            TempoRecord = "1:35.490",
                            TreinoLivre1 = new DateTime(2026, 11, 18, 22, 30, 0, 0, DateTimeKind.Utc),
                            TreinoLivre2 = new DateTime(2026, 11, 19, 2, 0, 0, 0, DateTimeKind.Utc),
                            TreinoLivre3 = new DateTime(2026, 11, 19, 22, 30, 0, 0, DateTimeKind.Utc),
                            Voltas = 50
                        },
                        new
                        {
                            ...
                            Classificacao = new DateTime(2026, 11, 27, 16, 0, 0, 0, DateTimeKind.Utc),
                            DataCorrida = new DateTime(2026, 11, 28, 12, 0, 0, 0, DateTimeKind.Utc),
                            Distancia = "306.6 km",
                            Encerrada = false,
                            LembreteEnviado = false,
                            LembreteUrgenteEnviado = false,
                            ...
                            Numero = 29,
                            Pais = "qa",
                            PrazoQualify = new DateTime(2026, 11, 28, 12, 0, 0, 0, DateTimeKind.Utc),
                            Recordista = "Charles Leclerc",
                            SemanaEnviada = false,
                            Sprint = false,
                            TempoRecord = "1:24.319",
                            TreinoLivre1 = new DateTime(2026, 11, 26, 12, 30, 0, 0, DateTimeKind.Utc),
                            TreinoLivre2 = new DateTime(2026, 11, 26, 16, 0, 0, 0, DateTimeKind.Utc),
                            TreinoLivre3 = new DateTime(2026, 11, 27, 12, 30, 0, 0, DateTimeKind.Utc),
                            Voltas = 57
                        },
                        new
                        {
                            ...
                            CircuitoTipo = "Circuito permanente",
                            Classificacao = new DateTime(2026, 12, 4, 12, 0, 0, 0, DateTimeKind.Utc),
                            DataCorrida = new DateTime(2026, 12, 5, 8, 0, 0, 0, DateTimeKind.Utc),
                            Distancia = "306.2 km",
                            Encerrada = false,
                            LembreteEnviado = false,
                            LembreteUrgenteEnviado = false,
                            ...
                            Numero = 30,
                            Pais = "ae",
                            PrazoQualify = new DateTime(2026, 12, 5, 8, 0, 0, 0, DateTimeKind.Utc),
                            Recordista = "Max Verstappen",
                            SemanaEnviada = false,
                            Sprint = false,
                            TempoRecord = "1:26.103",
                            TreinoLivre1 = new DateTime(2026, 12, 3, 8, 30, 0, 0, DateTimeKind.Utc),
                            TreinoLivre2 = new DateTime(2026, 12, 3, 12, 0, 0, 0, DateTimeKind.Utc),
                            TreinoLivre3 = new DateTime(2026, 12, 4, 8, 30, 0, 0, DateTimeKind.Utc),
                            Voltas = 58
                        });
                });

            modelBuilder.Entity("F1Fast.API.Models.LogAuditoria", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("F1Fast.API.Models.PushSubscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
